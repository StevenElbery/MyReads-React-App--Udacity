...
class Search extends Component {
    ...
    /**
     * Update the query to ping  api and search  api with specific query which updates the state of the page
     * @param {string} query string is used to request the API
     */
    updateQuery = (query) => {
